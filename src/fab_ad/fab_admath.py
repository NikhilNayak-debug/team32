...
def choose(n, k):
    ...
    ----------
    n : number
        invalid input cases handled by numpy
    k : number
        invalid input cases handled by numpy
...
def chain_rule(ad, new_val, der, der2, higher_der=None):
    ...
    ad : AD
        An AD object
    new_val : float
        Value of the new AD object
    der : float
        Derivative of the outer function in chain rule
    der2 : float
        Second derivative of the outer function in chain rule
    higher_der : float array, optional
        HIgher order derivatives, by default None

    Returns
    -------
    AD
       a new AD object with correct value and derivatives
...
def abs(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied absolute value function on

    Returns
    -------
    AD
        the new AD object after applying absolute value function
...
def exp(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied exponential function on

    Returns
    -------
    AD
        the new AD object after applying exponential function
...
def fact_ad(x, n):
    ...
    -------
    number
        x(x-1)(x-2)...(x-n+1) which is a scalar
...
def log(ad):  # consider different base?
    ...
    ----------
    ad : AD
        An AD object to be applied log(base e) function on

    Returns
    -------
    AD
        the new AD object after applying log(base e) function
...
def sqrt(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied square root function on

    Returns
    -------
    AD
        the new AD object after applying square root function
...
def sin(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied sine function on

    Returns
    -------
    AD
        the new AD object after applying sine function
...
def cos(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied cosine function on

    Returns
    -------
    AD
        the new AD object after applying cosine function
...
def tan(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied tangent function on

    Returns
    -------
    AD
        the new AD object after applying tangent function
...
def sec(num):
    ...
    ----------
    num : array
        array of numbers or a single number
...
def sinh(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied hyperbolic sine function on

    Returns
    -------
    AD
        the new AD object after applying hyperbolic sine function
...
def cosh(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied hyperbolic cosine function on

    Returns
    -------
    AD
        the new AD object after applying hyperbolic cosine function
...
def sech(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied hyperbolic secant function on

    Returns
    -------
    AD
        the new AD object after applying hyperbolic secant function
...
def tanh(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied hyperbolic tangent function on

    Returns
    -------
    AD
        the new AD object after applying hyperbolic tangent function
...
def sigmoid(ad):
    ...
    ----------
    ad : AD
        An AD object to be applied sigmoid function on

    Returns
    -------
    AD
        the new AD object after applying sigmoid function
